module alu8bit (VPWR,
 ...
 sky130_fd_sc_hd__or2_4 _470_ (.A(net56),
    ...
    .VPWR(VPWR),
    .X(_317_));
 sky130_fd_sc_hd__a2111oi_1 _471_ (.A1(net95),
    .A2(_231_),
    .B1(net63),
    .C1(_306_),
    .D1(_317_),
 ...
 sky130_fd_sc_hd__nor2_1 _487_ (.A(net65),
    ...
    .VPWR(VPWR),
    .Y(_416_));
 sky130_fd_sc_hd__and2_4 _488_ (.A(net65),
    .B(net69),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xor2_1 _522_ (.A(_415_),
    ...
    .VPWR(VPWR),
    .X(_451_));
 sky130_fd_sc_hd__mux2_2 _523_ (.A0(_434_),
    .A1(_450_),
    .S(_444_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _535_ (.A(net65),
    ...
    .VPWR(VPWR),
    .Y(_006_));
 sky130_fd_sc_hd__nor2_4 _536_ (.A(net35),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__or4_1 _549_ (.A(_006_),
    ...
    .VPWR(VPWR),
    .X(_020_));
 sky130_fd_sc_hd__a21o_1 _550_ (.A1(net73),
    .A2(net31),
    .B1(_210_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _560_ (.A(_448_),
    ...
    .VPWR(VPWR),
    .Y(_031_));
 sky130_fd_sc_hd__a21oi_1 _561_ (.A1(net73),
    .A2(net31),
    .B1(_446_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _564_ (.A(net55),
    ...
    .VPWR(VPWR),
    .Y(_035_));
 sky130_fd_sc_hd__a21o_1 _565_ (.A1(net73),
    .A2(_017_),
    .B1(_012_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _574_ (.A(_252_),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__a21oi_1 _575_ (.A1(net77),
    .A2(_043_),
    .B1(_252_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__a21o_1 _576_ (.A1(net77),
    .A2(_043_),
    .B1(_252_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _581_ (.A(_050_),
    ...
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__a21oi_1 _582_ (.A1(net83),
    .A2(_051_),
    .B1(net59),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _596_ (.A(_066_),
    ...
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__nor2_2 _597_ (.A(net59),
    .B(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _609_ (.A(_069_),
    ...
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__xor2_1 _610_ (.A(net80),
    .B(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _635_ (.A1(_440_),
    ...
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__and3_1 _636_ (.A(net81),
    .B(_440_),
    .C(_105_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_1 _641_ (.A0(_086_),
    ...
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__nor2_1 _642_ (.A(net80),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__nand2_1 _643_ (.A(net80),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _658_ (.A(_066_),
    ...
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__a211o_1 _659_ (.A1(net78),
    .A2(_127_),
    .B1(_129_),
    .C1(_252_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or4b_4 _690_ (.A(net3),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__a22oi_1 _691_ (.A1(net95),
    .A2(net44),
    .B1(_159_),
    .B2(_161_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__o22a_1 _692_ (.A1(net95),
    .A2(net44),
    .B1(_157_),
    .B2(_162_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4bb_2 _697_ (.A_N(net2),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__a32o_1 _698_ (.A1(net95),
    .A2(net44),
    .A3(_167_),
    .B1(_168_),
    .B2(net42),
 ...
 sky130_fd_sc_hd__and4bb_2 _704_ (.A_N(net1),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__a22o_1 _705_ (.A1(net95),
    .A2(net6),
    .B1(net64),
    .B2(net44),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _716_ (.A1(_147_),
    ...
    .VPWR(VPWR),
    .Y(_186_));
 sky130_fd_sc_hd__a22o_1 _717_ (.A1(net78),
    .A2(_295_),
    .B1(_185_),
    .B2(_186_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_187_));
 sky130_fd_sc_hd__or2_4 _718_ (.A(_187_),
    .B(_180_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _771_ (.A(_151_),
    ...
    .VPWR(VPWR),
    .Y(_244_));
 sky130_fd_sc_hd__xor2_1 _772_ (.A(net79),
    .B(_244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ba_1 _779_ (.A1(_223_),
    ...
    .VPWR(VPWR),
    .X(_253_));
 sky130_fd_sc_hd__and3_1 _780_ (.A(_007_),
    .B(net63),
    .C(net36),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_254_));
 sky130_fd_sc_hd__a21oi_4 _781_ (.A1(_455_),
    .A2(_224_),
    .B1(_254_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _816_ (.A(_290_),
    ...
    .VPWR(VPWR),
    .Y(_292_));
 sky130_fd_sc_hd__and3_1 _817_ (.A(_292_),
    .B(_259_),
    .C(_257_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _818_ (.A1(_257_),
    ...
    .VPWR(VPWR),
    .Y(_294_));
 sky130_fd_sc_hd__nor2_4 _819_ (.A(_293_),
    .B(_294_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _820_ (.A(_249_),
    ...
    .VPWR(VPWR),
    .Y(_297_));
 sky130_fd_sc_hd__or2_4 _821_ (.A(_297_),
    .B(_261_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _828_ (.A1(net37),
    ...
    .VPWR(VPWR),
    .X(_305_));
 sky130_fd_sc_hd__o21a_1 _829_ (.A1(net79),
    .A2(_151_),
    .B1(_160_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a22oi_1 _862_ (.A1(net13),
    ...
    .VPWR(VPWR),
    .Y(_342_));
 sky130_fd_sc_hd__or2_4 _863_ (.A(_341_),
    .B(_342_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21a_1 _866_ (.A1(_282_),
    ...
    .VPWR(VPWR),
    .X(_346_));
 sky130_fd_sc_hd__or2_4 _867_ (.A(_345_),
    .B(_346_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _872_ (.A1(_351_),
    ...
    .VPWR(VPWR),
    .Y(_353_));
 sky130_fd_sc_hd__or3_4 _873_ (.A(_332_),
    .B(_351_),
    .C(_352_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_354_));
 sky130_fd_sc_hd__nand2_4 _874_ (.A(_353_),
    .B(_354_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 input12 (.A(op_a[7]),
    ...
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__buf_6 input13 (.A(op_b[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_2 fanout42 (.A(net43),
    ...
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__buf_4 fanout43 (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_8 fanout65 (.A(net66),
    ...
    .VPWR(VPWR),
    .X(net65));
 sky130_fd_sc_hd__buf_8 fanout66 (.A(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_2 fanout68 (.A(net11),
    ...
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__clkbuf_4 fanout69 (.A(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer1 (.A(net71),
    ...
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer2 (.A(_061_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer3 (.A(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer4 (.A(_015_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer5 (.A(net75),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net74));
 sky130_fd_sc_hd__buf_1 rebuffer6 (.A(_079_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net75));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer7 (.A(net75),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net76));
 sky130_fd_sc_hd__buf_1 rebuffer8 (.A(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net77));
 sky130_fd_sc_hd__buf_6 clone9 (.A(_099_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net78));
 sky130_fd_sc_hd__clkbuf_1 clone10 (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net79));
 sky130_fd_sc_hd__clkbuf_1 clone11 (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net80));
 sky130_fd_sc_hd__clkbuf_1 clone12 (.A(net20),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net81));
 sky130_fd_sc_hd__buf_1 rebuffer14 (.A(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net83));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer20 (.A(_254_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net89));
 sky130_fd_sc_hd__clkbuf_1 clone26 (.A(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net95));
 sky130_fd_sc_hd__diode_2 ANTENNA_1 (.DIODE(net80),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 ...
 sky130_fd_sc_hd__fill_1 FILLER_18_203 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_8 FILLER_18_207 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__fill_2 FILLER_18_222 (.VGND(VGND),
    ...
    .VPB(VPWR),
    .VPWR(VPWR));
 sky130_fd_sc_hd__decap_6 FILLER_18_231 (.VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR));

module alu8bit (VPWR,
 ...
 sky130_fd_sc_hd__clkinv_4 _458_ (.A(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _459_ (.A(net3),
    ...
    .VPWR(VPWR),
    .Y(_199_));
 sky130_fd_sc_hd__inv_2 _460_ (.A(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_210_));
 sky130_fd_sc_hd__inv_2 _461_ (.A(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _462_ (.A(net12),
    ...
    .VPWR(VPWR),
    .Y(_231_));
 sky130_fd_sc_hd__inv_2 _463_ (.A(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_242_));
 sky130_fd_sc_hd__inv_2 _464_ (.A(net36),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_252_));
 sky130_fd_sc_hd__inv_2 _465_ (.A(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_263_));
 sky130_fd_sc_hd__inv_2 _466_ (.A(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _467_ (.A(net1),
    ...
    .VPWR(VPWR),
    .Y(_284_));
 sky130_fd_sc_hd__and3b_2 _468_ (.A_N(net4),
    .B(_284_),
    .C(net3),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_295_));
 sky130_fd_sc_hd__or4_4 _469_ (.A(net34),
    .B(net33),
    .C(net20),
    .D(net35),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_306_));
 sky130_fd_sc_hd__or2_4 _470_ (.A(net36),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_317_));
 sky130_fd_sc_hd__a2111oi_1 _471_ (.A1(net40),
    .A2(_231_),
    .B1(net38),
    .C1(net43),
    .D1(_317_),
    ...
    .VPWR(VPWR),
    .Y(_327_));
 sky130_fd_sc_hd__o41ai_4 _472_ (.A1(_188_),
    .A2(net38),
    .A3(_317_),
    .A4(_306_),
    .B1(net12),
    ...
    .VPWR(VPWR),
    .Y(_338_));
 sky130_fd_sc_hd__and2b_1 _473_ (.A_N(net11),
    .B(net40),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_349_));
 sky130_fd_sc_hd__a211o_1 _474_ (.A1(net38),
    .A2(_349_),
    .B1(_306_),
    .C1(_317_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_360_));
 sky130_fd_sc_hd__nor2_1 _475_ (.A(net38),
    .B(_349_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_370_));
 sky130_fd_sc_hd__or2_1 _476_ (.A(net38),
    .B(_349_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21bai_1 _477_ (.A1(_360_),
    ...
    .VPWR(VPWR),
    .Y(_392_));
 sky130_fd_sc_hd__a211oi_2 _478_ (.A1(net37),
    .A2(net69),
    .B1(net48),
    .C1(net36),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a211o_1 _481_ (.A1(_381_),
    ...
    .VPWR(VPWR),
    .X(_410_));
 sky130_fd_sc_hd__and3_1 _482_ (.A(net11),
    .B(_242_),
    .C(net56),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_411_));
 sky130_fd_sc_hd__nand3_1 _483_ (.A(net11),
    .B(_242_),
    .C(_410_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _484_ (.A1(_410_),
    ...
    .VPWR(VPWR),
    .X(_413_));
 sky130_fd_sc_hd__or2_1 _485_ (.A(net40),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_414_));
 sky130_fd_sc_hd__nor2_1 _486_ (.A(_188_),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_415_));
 sky130_fd_sc_hd__nor2_1 _487_ (.A(net40),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2_1 _488_ (.A(net40),
    ...
    .VPWR(VPWR),
    .X(_417_));
 sky130_fd_sc_hd__or2_1 _489_ (.A(_188_),
    .B(net10),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand3_1 _490_ (.A(_412_),
    ...
    .VPWR(VPWR),
    .Y(_419_));
 sky130_fd_sc_hd__nor2_1 _491_ (.A(net37),
    .B(_392_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_420_));
 sky130_fd_sc_hd__or2_1 _492_ (.A(net37),
    .B(_392_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_421_));
 sky130_fd_sc_hd__a211oi_2 _493_ (.A1(net71),
    .A2(_418_),
    .B1(_420_),
    .C1(_411_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _495_ (.A1(_412_),
    ...
    .VPWR(VPWR),
    .X(_424_));
 sky130_fd_sc_hd__a22o_1 _496_ (.A1(net11),
    .A2(net57),
    .B1(_423_),
    .B2(_403_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21o_1 _506_ (.A1(_431_),
    ...
    .VPWR(VPWR),
    .X(_435_));
 sky130_fd_sc_hd__a31o_1 _507_ (.A1(net39),
    .A2(_431_),
    .A3(_432_),
    .B1(_415_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _512_ (.A(_439_),
    ...
    .VPWR(VPWR),
    .X(_441_));
 sky130_fd_sc_hd__o21ba_4 _513_ (.A1(net36),
    .A2(_441_),
    .B1_N(_428_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__mux2_4 _517_ (.A0(_427_),
    ...
    .VPWR(VPWR),
    .X(_446_));
 sky130_fd_sc_hd__nor2_1 _518_ (.A(net36),
    .B(_446_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_2 _519_ (.A(_252_),
    ...
    .VPWR(VPWR),
    .Y(_448_));
 sky130_fd_sc_hd__xnor2_1 _520_ (.A(_242_),
    .B(_433_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _525_ (.A(net37),
    ...
    .VPWR(VPWR),
    .Y(_454_));
 sky130_fd_sc_hd__nand2_1 _526_ (.A(net40),
    .B(net29),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a211o_1 _530_ (.A1(_438_),
    ...
    .VPWR(VPWR),
    .X(_001_));
 sky130_fd_sc_hd__o21ai_1 _531_ (.A1(net29),
    .A2(_444_),
    .B1(_000_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_002_));
 sky130_fd_sc_hd__o211a_1 _532_ (.A1(net29),
    .A2(_444_),
    .B1(_000_),
    .C1(_242_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _534_ (.A_N(_003_),
    ...
    .VPWR(VPWR),
    .X(_005_));
 sky130_fd_sc_hd__nor2_1 _535_ (.A(net40),
    .B(net8),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_006_));
 sky130_fd_sc_hd__nor2_1 _536_ (.A(_188_),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_007_));
 sky130_fd_sc_hd__nand2_1 _537_ (.A(net40),
    .B(_210_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a311o_1 _544_ (.A1(_448_),
    ...
    .VPWR(VPWR),
    .X(_015_));
 sky130_fd_sc_hd__and3_1 _545_ (.A(net35),
    .B(_440_),
    .C(_012_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_016_));
 sky130_fd_sc_hd__nor4_2 _546_ (.A(net65),
    .B(net20),
    .C(net53),
    .D(_016_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_017_));
 sky130_fd_sc_hd__or4_4 _547_ (.A(net64),
    .B(net20),
    .C(net53),
    .D(_016_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _552_ (.A(_022_),
    ...
    .VPWR(VPWR),
    .Y(_023_));
 sky130_fd_sc_hd__and2_1 _553_ (.A(_242_),
    .B(_022_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _554_ (.A1(_020_),
    ...
    .VPWR(VPWR),
    .X(_025_));
 sky130_fd_sc_hd__and3_1 _555_ (.A(net38),
    .B(_020_),
    .C(_021_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _557_ (.A(_188_),
    ...
    .VPWR(VPWR),
    .Y(_028_));
 sky130_fd_sc_hd__or2_1 _558_ (.A(_188_),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _562_ (.A1(_019_),
    ...
    .VPWR(VPWR),
    .Y(_033_));
 sky130_fd_sc_hd__or2_1 _563_ (.A(net35),
    .B(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_034_));
 sky130_fd_sc_hd__xnor2_1 _564_ (.A(net35),
    .B(_033_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21o_1 _565_ (.A1(_015_),
    ...
    .VPWR(VPWR),
    .X(_036_));
 sky130_fd_sc_hd__and3_1 _566_ (.A(net66),
    .B(_440_),
    .C(_036_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and3_1 _574_ (.A(_252_),
    ...
    .VPWR(VPWR),
    .X(_045_));
 sky130_fd_sc_hd__a21oi_1 _575_ (.A1(net47),
    .A2(_043_),
    .B1(_252_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_046_));
 sky130_fd_sc_hd__a21o_1 _576_ (.A1(net47),
    .A2(_043_),
    .B1(_252_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__or3_4 _580_ (.A(_014_),
    ...
    .VPWR(VPWR),
    .X(_051_));
 sky130_fd_sc_hd__and2_1 _581_ (.A(net72),
    .B(_051_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_052_));
 sky130_fd_sc_hd__a21oi_1 _582_ (.A1(net72),
    .A2(_051_),
    .B1(net37),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_053_));
 sky130_fd_sc_hd__and3_1 _583_ (.A(net37),
    .B(_051_),
    .C(_050_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _596_ (.A(_066_),
    ...
    .VPWR(VPWR),
    .Y(_067_));
 sky130_fd_sc_hd__nor2_1 _597_ (.A(net37),
    .B(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_068_));
 sky130_fd_sc_hd__and2_1 _598_ (.A(net37),
    .B(_066_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_069_));
 sky130_fd_sc_hd__nand2_1 _599_ (.A(_188_),
    .B(net30),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _600_ (.A(_029_),
    ...
    .VPWR(VPWR),
    .Y(_071_));
 sky130_fd_sc_hd__mux2_4 _601_ (.A0(net30),
    .A1(_071_),
    .S(_061_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _602_ (.A(_072_),
    ...
    .VPWR(VPWR),
    .Y(_073_));
 sky130_fd_sc_hd__and2_1 _603_ (.A(_242_),
    .B(_072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_074_));
 sky130_fd_sc_hd__xnor2_2 _604_ (.A(net38),
    .B(_072_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _609_ (.A(_069_),
    ...
    .VPWR(VPWR),
    .Y(_080_));
 sky130_fd_sc_hd__xor2_1 _610_ (.A(net58),
    .B(_064_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o21ai_1 _611_ (.A1(_036_),
    ...
    .VPWR(VPWR),
    .Y(_082_));
 sky130_fd_sc_hd__xnor2_1 _612_ (.A(net52),
    .B(_082_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_4 _615_ (.A0(_044_),
    ...
    .VPWR(VPWR),
    .X(_086_));
 sky130_fd_sc_hd__and2_4 _616_ (.A(net35),
    .B(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_087_));
 sky130_fd_sc_hd__xor2_1 _617_ (.A(net35),
    .B(_086_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _620_ (.A(_252_),
    ...
    .VPWR(VPWR),
    .Y(_091_));
 sky130_fd_sc_hd__xnor2_1 _621_ (.A(net36),
    .B(_090_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand4_1 _622_ (.A(_081_),
    ...
    .VPWR(VPWR),
    .Y(_093_));
 sky130_fd_sc_hd__o22a_1 _623_ (.A1(net35),
    .A2(_086_),
    .B1(net36),
    .B2(_090_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21bai_1 _632_ (.A1(_087_),
    ...
    .VPWR(VPWR),
    .Y(_103_));
 sky130_fd_sc_hd__a31o_1 _633_ (.A1(_099_),
    .A2(_102_),
    .A3(_103_),
    .B1(_100_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a21oi_1 _635_ (.A1(_440_),
    ...
    .VPWR(VPWR),
    .Y(_106_));
 sky130_fd_sc_hd__and3_1 _636_ (.A(net20),
    .B(_440_),
    .C(_105_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_107_));
 sky130_fd_sc_hd__xor2_1 _637_ (.A(net51),
    .B(_104_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _641_ (.A0(_086_),
    ...
    .VPWR(VPWR),
    .X(_112_));
 sky130_fd_sc_hd__nor2_1 _642_ (.A(net67),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_113_));
 sky130_fd_sc_hd__nand2_1 _643_ (.A(net67),
    .B(_112_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__mux2_1 _645_ (.A0(_090_),
    ...
    .VPWR(VPWR),
    .X(_116_));
 sky130_fd_sc_hd__or2_1 _646_ (.A(net35),
    .B(_116_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _658_ (.A(_066_),
    ...
    .VPWR(VPWR),
    .Y(_129_));
 sky130_fd_sc_hd__a211o_1 _659_ (.A1(net41),
    .A2(_127_),
    .B1(_129_),
    .C1(_252_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2b_1 _662_ (.A_N(_132_),
    ...
    .VPWR(VPWR),
    .Y(_133_));
 sky130_fd_sc_hd__nand2_1 _663_ (.A(_188_),
    .B(net31),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nand2_1 _664_ (.A(_076_),
    ...
    .VPWR(VPWR),
    .Y(_135_));
 sky130_fd_sc_hd__mux2_1 _665_ (.A0(net31),
    .A1(_135_),
    .S(_099_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2_1 _666_ (.A(_188_),
    ...
    .VPWR(VPWR),
    .X(_137_));
 sky130_fd_sc_hd__nor2_1 _667_ (.A(_242_),
    .B(_136_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_138_));
 sky130_fd_sc_hd__o211a_1 _668_ (.A1(net31),
    .A2(_242_),
    .B1(_188_),
    .C1(net5),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_139_));
 sky130_fd_sc_hd__a21o_1 _669_ (.A1(_242_),
    .A2(_136_),
    .B1(_139_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _673_ (.A(_104_),
    ...
    .VPWR(VPWR),
    .Y(_144_));
 sky130_fd_sc_hd__a21oi_1 _674_ (.A1(net49),
    .A2(_144_),
    .B1(_107_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _679_ (.A1(_149_),
    ...
    .VPWR(VPWR),
    .X(_150_));
 sky130_fd_sc_hd__or3_1 _680_ (.A(net40),
    .B(net38),
    .C(_317_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_151_));
 sky130_fd_sc_hd__or2_1 _681_ (.A(net43),
    .B(_151_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_152_));
 sky130_fd_sc_hd__or4_1 _682_ (.A(net10),
    .B(net29),
    .C(net12),
    .D(net11),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_153_));
 sky130_fd_sc_hd__or4_1 _683_ (.A(net5),
    .B(net31),
    .C(net8),
    .D(net30),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or4b_4 _690_ (.A(net3),
    ...
    .VPWR(VPWR),
    .X(_161_));
 sky130_fd_sc_hd__a22oi_1 _691_ (.A1(net40),
    .A2(net32),
    .B1(_159_),
    .B2(_161_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_162_));
 sky130_fd_sc_hd__o22a_1 _692_ (.A1(net40),
    .A2(net32),
    .B1(_157_),
    .B2(_162_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__and4bb_2 _697_ (.A_N(net2),
    ...
    .VPWR(VPWR),
    .X(_168_));
 sky130_fd_sc_hd__a32o_1 _698_ (.A1(net40),
    .A2(net32),
    .A3(_167_),
    .B1(_168_),
    .B2(net31),
 ...
 sky130_fd_sc_hd__or3_4 _700_ (.A(_156_),
    ...
    .VPWR(VPWR),
    .X(net21));
 sky130_fd_sc_hd__and2_1 _701_ (.A(net31),
    .B(net38),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and4bb_2 _704_ (.A_N(net1),
    ...
    .VPWR(VPWR),
    .X(_174_));
 sky130_fd_sc_hd__a22o_1 _705_ (.A1(net40),
    .A2(net6),
    .B1(net38),
    .B2(net32),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_175_));
 sky130_fd_sc_hd__and3_1 _706_ (.A(net13),
    .B(net32),
    .C(_171_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__inv_2 _707_ (.A(_176_),
    ...
    .VPWR(VPWR),
    .Y(_177_));
 sky130_fd_sc_hd__a22o_1 _708_ (.A1(net30),
    .A2(_168_),
    .B1(_171_),
    .B2(_166_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _719_ (.A1(net13),
    ...
    .VPWR(VPWR),
    .X(_189_));
 sky130_fd_sc_hd__xnor2_1 _720_ (.A(net37),
    .B(_189_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_190_));
 sky130_fd_sc_hd__or2_1 _721_ (.A(net30),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_191_));
 sky130_fd_sc_hd__nand2_1 _722_ (.A(net30),
    .B(_190_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and3_1 _728_ (.A(net13),
    ...
    .VPWR(VPWR),
    .X(_198_));
 sky130_fd_sc_hd__o2bb2a_1 _729_ (.A1_N(net32),
    .A2_N(net15),
    .B1(_197_),
    .B2(_198_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _734_ (.A(_203_),
    ...
    .VPWR(VPWR),
    .Y(_205_));
 sky130_fd_sc_hd__nand2_1 _735_ (.A(net30),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__and2b_1 _736_ (.A_N(_159_),
    ...
    .VPWR(VPWR),
    .X(_207_));
 sky130_fd_sc_hd__o22a_1 _737_ (.A1(net30),
    .A2(net15),
    .B1(_157_),
    .B2(_207_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_208_));
 sky130_fd_sc_hd__a32o_1 _738_ (.A1(net30),
    .A2(net15),
    .A3(_166_),
    .B1(_168_),
    .B2(net8),
    ...
    .VPWR(VPWR),
    .X(_209_));
 sky130_fd_sc_hd__a221o_1 _739_ (.A1(net6),
    .A2(_174_),
    .B1(_205_),
    .B2(_165_),
    .C1(_208_),
 ...
 sky130_fd_sc_hd__a21o_1 _741_ (.A1(_194_),
    ...
    .VPWR(VPWR),
    .X(net23));
 sky130_fd_sc_hd__o31a_1 _742_ (.A1(net13),
    .A2(net38),
    .A3(net15),
    .B1(_160_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_213_));
 sky130_fd_sc_hd__xnor2_1 _743_ (.A(net36),
    .B(_213_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_214_));
 sky130_fd_sc_hd__or2_1 _744_ (.A(net8),
    .B(_214_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_215_));
 sky130_fd_sc_hd__nand2_1 _745_ (.A(net8),
    .B(_214_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__nor2_1 _750_ (.A(_198_),
    ...
    .VPWR(VPWR),
    .Y(_222_));
 sky130_fd_sc_hd__nand2_1 _751_ (.A(net31),
    .B(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_223_));
 sky130_fd_sc_hd__nand2_1 _752_ (.A(net8),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_224_));
 sky130_fd_sc_hd__and3_1 _753_ (.A(net30),
    .B(net38),
    .C(_007_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_225_));
 sky130_fd_sc_hd__a21oi_1 _754_ (.A1(net30),
    .A2(net39),
    .B1(_007_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _758_ (.A(_222_),
    ...
    .VPWR(VPWR),
    .Y(_230_));
 sky130_fd_sc_hd__and3_1 _759_ (.A(net32),
    .B(net36),
    .C(_230_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_232_));
 sky130_fd_sc_hd__a21oi_1 _760_ (.A1(net32),
    .A2(net36),
    .B1(_230_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _764_ (.A1(_203_),
    ...
    .VPWR(VPWR),
    .X(_237_));
 sky130_fd_sc_hd__a21oi_1 _765_ (.A1(net8),
    .A2(net36),
    .B1(_159_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_238_));
 sky130_fd_sc_hd__o22a_1 _766_ (.A1(net8),
    .A2(net36),
    .B1(_157_),
    .B2(_238_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_239_));
 sky130_fd_sc_hd__a32o_1 _767_ (.A1(net8),
    .A2(net36),
    .A3(_166_),
    .B1(_174_),
    .B2(net30),
    ...
    .VPWR(VPWR),
    .X(_240_));
 sky130_fd_sc_hd__a221o_1 _768_ (.A1(net29),
    .A2(_168_),
    .B1(_236_),
    .B2(_237_),
    .C1(_239_),
 ...
 sky130_fd_sc_hd__nand2_1 _771_ (.A(_151_),
    ...
    .VPWR(VPWR),
    .Y(_244_));
 sky130_fd_sc_hd__xor2_1 _772_ (.A(net35),
    .B(_244_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_245_));
 sky130_fd_sc_hd__xnor2_1 _773_ (.A(net29),
    .B(_245_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a21oi_1 _775_ (.A1(_216_),
    ...
    .VPWR(VPWR),
    .Y(_248_));
 sky130_fd_sc_hd__and4_1 _776_ (.A(net32),
    .B(net31),
    .C(net36),
    .D(net74),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_249_));
 sky130_fd_sc_hd__a22oi_1 _777_ (.A1(net31),
    .A2(net16),
    .B1(net74),
    .B2(net32),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21ba_1 _779_ (.A1(_223_),
    ...
    .VPWR(VPWR),
    .X(_253_));
 sky130_fd_sc_hd__and3_1 _780_ (.A(net29),
    .B(net39),
    .C(_007_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_254_));
 sky130_fd_sc_hd__a21oi_1 _781_ (.A1(_455_),
    .A2(_224_),
    .B1(_254_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _791_ (.A(_235_),
    ...
    .VPWR(VPWR),
    .Y(_266_));
 sky130_fd_sc_hd__a21oi_1 _792_ (.A1(net29),
    .A2(net74),
    .B1(_159_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_267_));
 sky130_fd_sc_hd__o22a_1 _793_ (.A1(net29),
    .A2(net74),
    .B1(_157_),
    .B2(_267_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_268_));
 sky130_fd_sc_hd__and2_1 _794_ (.A(net10),
    .B(_168_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_269_));
 sky130_fd_sc_hd__a32o_1 _795_ (.A1(net9),
    .A2(net17),
    .A3(_166_),
    .B1(_174_),
    .B2(net8),
 ...
 sky130_fd_sc_hd__o31ai_1 _798_ (.A1(_161_),
    ...
    .VPWR(VPWR),
    .Y(net25));
 sky130_fd_sc_hd__nand2_1 _799_ (.A(net32),
    .B(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_274_));
 sky130_fd_sc_hd__and4_1 _800_ (.A(net31),
    .B(net7),
    .C(net16),
    .D(net17),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_275_));
 sky130_fd_sc_hd__a22oi_1 _801_ (.A1(net7),
    .A2(net16),
    .B1(net17),
    .B2(net31),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nor2_1 _804_ (.A(_277_),
    ...
    .VPWR(VPWR),
    .Y(_279_));
 sky130_fd_sc_hd__a31oi_1 _805_ (.A1(net7),
    .A2(net37),
    .A3(_255_),
    .B1(_254_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_280_));
 sky130_fd_sc_hd__nand2_1 _806_ (.A(net8),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_281_));
 sky130_fd_sc_hd__and3_1 _807_ (.A(net29),
    .B(net39),
    .C(_417_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_282_));
 sky130_fd_sc_hd__a21oi_1 _808_ (.A1(net29),
    .A2(net39),
    .B1(_417_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _827_ (.A1(_266_),
    ...
    .VPWR(VPWR),
    .X(_304_));
 sky130_fd_sc_hd__a21o_1 _828_ (.A1(net9),
    .A2(_245_),
    .B1(_248_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__o21a_1 _829_ (.A1(net17),
    ...
    .VPWR(VPWR),
    .X(_307_));
 sky130_fd_sc_hd__xnor2_1 _830_ (.A(net60),
    .B(_307_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_308_));
 sky130_fd_sc_hd__or2_1 _831_ (.A(net10),
    .B(_308_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(_309_));
 sky130_fd_sc_hd__nand2_1 _832_ (.A(net10),
    .B(_308_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__a32o_1 _839_ (.A1(net10),
    ...
    .VPWR(VPWR),
    .X(_318_));
 sky130_fd_sc_hd__a221o_1 _840_ (.A1(net9),
    .A2(_174_),
    .B1(_302_),
    .B2(_304_),
    .C1(_316_),
 ...
 sky130_fd_sc_hd__or3_1 _842_ (.A(_318_),
    ...
    .VPWR(VPWR),
    .X(net26));
 sky130_fd_sc_hd__a21o_1 _843_ (.A1(net62),
    .A2(_160_),
    .B1(_307_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_321_));
 sky130_fd_sc_hd__xor2_1 _844_ (.A(net49),
    .B(_321_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__inv_2 _845_ (.A(_322_),
    ...
    .VPWR(VPWR),
    .Y(_323_));
 sky130_fd_sc_hd__xor2_1 _846_ (.A(net11),
    .B(_322_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__o211a_1 _851_ (.A1(_275_),
    ...
    .VPWR(VPWR),
    .X(_330_));
 sky130_fd_sc_hd__a211oi_1 _852_ (.A1(net32),
    .A2(net54),
    .B1(_275_),
    .C1(_278_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__or2_1 _853_ (.A(_330_),
    ...
    .VPWR(VPWR),
    .X(_332_));
 sky130_fd_sc_hd__nand2_1 _854_ (.A(net31),
    .B(net63),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_333_));
 sky130_fd_sc_hd__a22oi_1 _855_ (.A1(net8),
    .A2(net16),
    .B1(net17),
    .B2(net7),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_334_));
 sky130_fd_sc_hd__and4_1 _856_ (.A(net8),
    .B(net7),
    .C(net16),
    .D(net17),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _858_ (.A(_333_),
    ...
    .VPWR(VPWR),
    .Y(_337_));
 sky130_fd_sc_hd__nand2_1 _859_ (.A(net29),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_339_));
 sky130_fd_sc_hd__nand2_1 _860_ (.A(net11),
    .B(net39),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_340_));
 sky130_fd_sc_hd__and3_1 _861_ (.A(net11),
    .B(net39),
    .C(_417_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .X(_341_));
 sky130_fd_sc_hd__a22oi_1 _862_ (.A1(net40),
    .A2(net11),
    .B1(net39),
    .B2(net10),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__nand2_1 _879_ (.A(_303_),
    ...
    .VPWR(VPWR),
    .Y(_361_));
 sky130_fd_sc_hd__a21oi_1 _880_ (.A1(net11),
    .A2(net50),
    .B1(_159_),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(_362_));
 sky130_fd_sc_hd__o22a_1 _881_ (.A1(net11),
    .A2(net50),
    .B1(_157_),
    .B2(_362_),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_363_));
 sky130_fd_sc_hd__a32o_1 _882_ (.A1(net11),
    .A2(net50),
    .A3(_166_),
    .B1(_174_),
    .B2(net10),
 ...
 sky130_fd_sc_hd__a31o_1 _885_ (.A1(_165_),
    ...
    .VPWR(VPWR),
    .X(net27));
 sky130_fd_sc_hd__a21oi_1 _886_ (.A1(net11),
    .A2(_323_),
    .B1(_325_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__xnor2_1 _887_ (.A(net12),
    ...
    .VPWR(VPWR),
    .Y(_368_));
 sky130_fd_sc_hd__a21o_1 _888_ (.A1(net49),
    .A2(_160_),
    .B1(_321_),
    .VGND(VGND),
    .VNB(VGND),
 ...
 sky130_fd_sc_hd__and2b_1 _894_ (.A_N(_352_),
    ...
    .VPWR(VPWR),
    .X(_376_));
 sky130_fd_sc_hd__nand2_1 _895_ (.A(net7),
    .B(net73),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_377_));
 sky130_fd_sc_hd__a22o_1 _896_ (.A1(net32),
    .A2(net20),
    .B1(net54),
    .B2(net31),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .X(_378_));
 sky130_fd_sc_hd__nand4_1 _897_ (.A(net32),
    .B(net31),
    .C(net20),
    .D(net19),
    .VGND(VGND),
    ...
    .VPWR(VPWR),
    .Y(_379_));
 sky130_fd_sc_hd__a22o_1 _898_ (.A1(net29),
    .A2(net16),
    .B1(net17),
    .B2(net8),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__o21bai_1 _904_ (.A1(_339_),
    ...
    .VPWR(VPWR),
    .Y(_387_));
 sky130_fd_sc_hd__nand2_1 _905_ (.A(net10),
    .B(net37),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .Y(_388_));
 sky130_fd_sc_hd__nand2_1 _906_ (.A(net40),
    .B(net12),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
 ...
 sky130_fd_sc_hd__xnor2_1 _910_ (.A(_386_),
    ...
    .VPWR(VPWR),
    .Y(_394_));
 sky130_fd_sc_hd__a31o_1 _911_ (.A1(net31),
    .A2(net73),
    .A3(_336_),
    .B1(_335_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__a32o_1 _921_ (.A1(net12),
    ...
    .VPWR(VPWR),
    .X(_406_));
 sky130_fd_sc_hd__a211o_1 _922_ (.A1(net11),
    .A2(_174_),
    .B1(_405_),
    .C1(_406_),
    .VGND(VGND),
 ...
 sky130_fd_sc_hd__buf_2 input3 (.A(inst[2]),
    ...
    .VPWR(VPWR),
    .X(net3));
 sky130_fd_sc_hd__buf_2 input4 (.A(inst[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net4));
 sky130_fd_sc_hd__clkbuf_2 input5 (.A(op_a[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net5));
 sky130_fd_sc_hd__buf_2 input6 (.A(op_a[1]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net6));
 sky130_fd_sc_hd__clkbuf_2 input7 (.A(op_a[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net7));
 sky130_fd_sc_hd__buf_4 input8 (.A(op_a[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net8));
 sky130_fd_sc_hd__clkbuf_2 input9 (.A(op_a[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net9));
 sky130_fd_sc_hd__clkbuf_4 input10 (.A(op_a[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net10));
 sky130_fd_sc_hd__buf_4 input11 (.A(op_a[6]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_4 input12 (.A(op_a[7]),
    ...
    .VPWR(VPWR),
    .X(net12));
 sky130_fd_sc_hd__buf_2 input13 (.A(op_b[0]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__clkbuf_1 input14 (.A(op_b[1]),
    ...
    .VPWR(VPWR),
    .X(net14));
 sky130_fd_sc_hd__buf_2 input15 (.A(op_b[2]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net15));
 sky130_fd_sc_hd__buf_2 input16 (.A(op_b[3]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net16));
 sky130_fd_sc_hd__buf_4 input17 (.A(op_b[4]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net17));
 sky130_fd_sc_hd__buf_8 input18 (.A(op_b[5]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net18));
 sky130_fd_sc_hd__buf_6 input19 (.A(op_b[6]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net19));
 sky130_fd_sc_hd__clkbuf_8 input20 (.A(op_b[7]),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_1 output28 (.A(net28),
    ...
    .VPWR(VPWR),
    .X(op_out[7]));
 sky130_fd_sc_hd__buf_4 fanout29 (.A(net9),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net29));
 sky130_fd_sc_hd__clkbuf_4 fanout30 (.A(net7),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net30));
 sky130_fd_sc_hd__clkbuf_4 fanout31 (.A(net6),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net31));
 sky130_fd_sc_hd__clkbuf_4 fanout32 (.A(net5),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net32));
 sky130_fd_sc_hd__buf_12 fanout33 (.A(net19),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net33));
 sky130_fd_sc_hd__buf_12 fanout34 (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net34));
 sky130_fd_sc_hd__buf_12 fanout35 (.A(net17),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net35));
 sky130_fd_sc_hd__buf_4 fanout36 (.A(net16),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net36));
 sky130_fd_sc_hd__buf_4 fanout37 (.A(net15),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__buf_4 fanout38 (.A(net39),
    ...
    .VPWR(VPWR),
    .X(net38));
 sky130_fd_sc_hd__clkbuf_4 fanout39 (.A(net14),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net39));
 sky130_fd_sc_hd__buf_4 fanout40 (.A(net13),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net40));
 sky130_fd_sc_hd__a21oi_2 clone1 (.A1(_098_),
    .A2(_095_),
    .B1(net20),
    .VGND(VGND),
    .VNB(VGND),
    ...
    .VPWR(VPWR),
    .Y(net41));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer2 (.A(_338_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net42));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer3 (.A(_306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net43));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer4 (.A(_306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net44));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer5 (.A(_423_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net45));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer6 (.A(net45),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net46));
 sky130_fd_sc_hd__buf_1 rebuffer7 (.A(_042_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net47));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer8 (.A(_306_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net48));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer9 (.A(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net49));
 sky130_fd_sc_hd__dlymetal6s2s_1 rebuffer10 (.A(net49),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net50));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer11 (.A(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer12 (.A(net33),
    ...
    .VPWR(VPWR),
    .X(net52));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer13 (.A(net33),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net53));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer14 (.A(net53),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net54));
 sky130_fd_sc_hd__clkbuf_1 rebuffer15 (.A(_413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net55));
 sky130_fd_sc_hd__buf_1 rebuffer16 (.A(_410_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net56));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer17 (.A(net56),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net57));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer18 (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer19 (.A(net34),
    ...
    .VPWR(VPWR),
    .X(net59));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer20 (.A(net59),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net60));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer21 (.A(net60),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer23 (.A(net59),
    ...
    .VPWR(VPWR),
    .X(net63));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer24 (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net64));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer25 (.A(net64),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
 ...
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer26 (.A(net64),
    ...
    .VPWR(VPWR),
    .X(net66));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer27 (.A(net34),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net67));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer28 (.A(_360_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net68));
 sky130_fd_sc_hd__buf_1 rebuffer29 (.A(_338_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net69));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer30 (.A(net69),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net70));
 sky130_fd_sc_hd__buf_6 rebuffer31 (.A(_413_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net71));
 sky130_fd_sc_hd__buf_1 rebuffer32 (.A(_050_),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net72));
 sky130_fd_sc_hd__dlygate4sd1_1 rebuffer33 (.A(net18),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
    .X(net73));
 sky130_fd_sc_hd__buf_1 rebuffer34 (.A(net35),
    .VGND(VGND),
    .VNB(VGND),
    .VPB(VPWR),
    .VPWR(VPWR),
